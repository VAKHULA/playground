import{j as e}from"./jsx-runtime-jS_PcZPR.js";import{r as v}from"./iframe-CxYkFzcR.js";import{C as a,u as m,a as n}from"./react-three-fiber.esm-CAOOYg1x.js";import"./preload-helper-PPVm8Dsz.js";import"./three.module-b4iiaVlP.js";const l=()=>{const r=v.useRef(null),i=m(c=>c.viewport),s=v.useMemo(()=>({u_time:{value:0}}),[]);return n(c=>{const{clock:x}=c;r.current.material.uniforms.u_time.value=x.getElapsedTime()}),e.jsxs("mesh",{ref:r,scale:[i.width,i.height,1],children:[e.jsx("planeGeometry",{}),e.jsx("shaderMaterial",{vertexShader:`
          varying vec2 vUv;
          varying vec3 v_pos;
